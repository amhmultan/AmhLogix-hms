        ...
        <div id="printableArea" class="opd-page">
            ...
            <div class="row header-wrap align-items-center">
                ...
                <div class="col-sm-4 text-center">
                    ...
                    <img src="{{ asset('img/'.$hospital->logo) }}" width="150px" height="150px" alt="Hospital Logo" class="rounded mx-auto d-block" />
                </div>
                ...
                <div class="footer">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <span class="footer-urdu-remarks">ٹائم لینے کے لئے صبح 9 بجے اس نمبر پر رابطہ کریں:</span> {{ $hospital->contact ?? 'N/A' }}
                        </div>
                        <div class="col-sm-6 text-right">
                            <span class="footer-urdu-remarks">(بروزجمعۃالمبارک کلینک بندرہےگا)</span>
                        </div>
                    </div>
                    <span class="footer-urdu-remarks-again">{{ $doctor->remarks ?? '-' }}</span>
                </div>
        </div>
