    ...
    <div class="container bg-white shadow-md rounded my-6 px-5 py-4">
      ...
      <div class="row pb-4">
        <h3 class="text-danger">
          <strong><em>Edit <span class="text-success">Bed</span></em></strong>
        </h3>        
        <hr />
      </div>
      ...
      <form method="POST" action="{{ route('admin.beds.update', $bed->id) }}">
        ...
        <div class="row my-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="bed_number" value="{{ old('bed_number', $bed->bed_number) }}" class="form-control" required>
          </div>
        </div>
        ...
        <div class="row my-3">
          <div class="col-md-6">
            ...
            <input type="number" name="rate_per_day" value="{{ old('rate_per_day', $bed->rate_per_day) }}" class="form-control" step="0.01" required>
          </div>
          <div class="col-md-6">
